...
class _PassengerPageState extends State<PassengerPage> {
      ...
      try {
        ...
        if (res.statusCode == 200) {
          ...
          if (!resultJson['Status'])
            Dialogs.showMessage(context, "Thất bại", resultJson['Message'].toString());
        ...
        print(ex);
        Navigator.of(_keyLoader.currentContext, rootNavigator: true).pop();
        Dialogs.showMessage(context, "Thất bại", "Kiểm tra tình trạng kết nối internet.");
      }
    }
  }
  ...
  Widget createPassengerForm(int index) {
    ...
    final dobField = TextFormField(
        ...
        validator: (value) {
          if (value == null || value.isEmpty) {
            return "Nhập ngày sinh hành khách";
          }
          return null;
        },
        decoration: InputDecoration(
        ...
        onEditingComplete: () {
          ...
          if (DateFormat('dd/MM/yyyy').format(DateFormat('dd/MM/yyyy').parse(dobController.text)).toString().compareTo(dobController.text) == 0) {
            ...
            if (age < 12) {
              ...
              TicketType newValue = listTicketTypes.firstWhere((element) => element.text == "Vé trẻ em");
      ...
      child: Column(children: <Widget>[
        Container(
          ...
          child: Row(mainAxisSize: MainAxisSize.min, children: <Widget>[
            ...
            SizedBox(width: 15.0),
            Expanded(child: Text("Giá: " + oCcy.format(listPrices[index].priceWithVAT.round()).toString() + " VND") // <-- Wrapped in Expanded.
                )
          ]),
        ),
        Container(
  ...
  Widget build(BuildContext context) {
    final nextButton = Material(
      ...
      child: MaterialButton(
        ...
        child: Text("Xuất vé", textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
      ),
    );
