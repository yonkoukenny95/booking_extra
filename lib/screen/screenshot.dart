          ...
          return Container(
            ...
            child: Column(
                ...
                children: <Widget>[
                  ...
                  SizedBox(height: 20),
                  Text('Vui lòng có mặt 15 phút trước giờ tàu chạy tại CẢNG HÀ TIÊN', style: TextStyle(fontSize: 15)),
                  Text('Please be presented 30 minutes prior to the depart time at HA TIEN PORT', style: TextStyle(fontSize: 15)),
                ]),
          );
        });
  }
